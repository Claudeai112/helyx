...
export default function PrivacyPage() {
  return (
    <LegalLayout title="Privacy Policy">
      ...
      <p>
        <strong>Research order information:</strong> Details of products ordered, quantities, and
        shipping address associated with each research-supply purchase.
      </p>
      <p>
      ...
      <p>
        We use your information to: process and fulfill research-supply orders; send transactional
        communications (order confirmation, shipping updates); provide customer support; and comply
        with legal obligations.
      </p>

      <h2>3. Sharing With Service Providers</h2>
      <p>
        We share necessary order information with shipping carriers and payment processors to
        fulfill your order. These parties are bound by contractual data security obligations. We do
      ...
      <p>
        ...
        messages related to your account and orders. Marketing communications (e.g., promotional
        emails or SMS) require separate opt-in consent, which you may withdraw at any time by
        following the unsubscribe instructions in any such message or contacting our support team.
      ...
      <p>
        We retain personal information for as long as your account is active or as required by
        applicable law.
      </p>
      ...
      <p>
        ...
        information cannot be deleted where retention is required by law.
      </p>
